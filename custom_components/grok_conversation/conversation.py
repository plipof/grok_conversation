...
async def _transform_stream(
    ...
    async for event in result:
        ...
        if isinstance(event, ResponseOutputItemAddedEvent):
            ...
            raise HomeAssistantError(f"Grok response incomplete: {reason}")
            ...
            raise HomeAssistantError(f"Grok response failed: {reason}")
        elif isinstance(event, ResponseErrorEvent):
            raise HomeAssistantError(f"Grok response error: {event.message}")
